/* web share enhancement based on https://github.com/philnash/web-share-wrapper */
class WebShareWrapper extends HTMLElement {
    ...
    abortedShare(error, options) {
        ...
        window.open(`https://twitter.com/intent/tweet?text=${this.getText()}&amp;url=https://justmarkup.com/${this.getUrl()}`, '_blank');
    }
